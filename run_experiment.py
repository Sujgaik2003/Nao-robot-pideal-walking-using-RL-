...
import pickle
import sys
sys.path.append("/content/drive/MyDrive/LearningHumanoidWalking-main/rl/algos")
...
def import_env(env_name_str):
    ...
    elif env_name_str=='nao_walk':
        from envs.nao import naoStepEnv as Env   
    elif env_name_str=='nao_step':
          from envs.nao import naoStepEnv as Env    
    else:
